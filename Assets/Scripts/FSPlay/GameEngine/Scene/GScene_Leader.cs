    ...
    public partial class GScene
    {
        ...
        private void LoadLeader(int x, int y, int direction)
        {
            ...
            role.Data = new RoleDataMini()
            {
                ...
                MaskID = mask == null ? -1 : mask.GoodsID,
                ChanNguyenID = channguyen == null ? -1 : channguyen.GoodsID,
                NgoaiTrangID = ngoaitrang == null ? -1 : ngoaitrang.GoodsID,
                ThanBinhID = thanbinh == null ? -1 : thanbinh.GoodsID,
            };
            role.UpdateRoleData();
