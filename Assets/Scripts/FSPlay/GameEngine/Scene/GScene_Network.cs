...
namespace FSPlay.GameEngine.Scene
{
    ...
    public partial class GScene
    {
        ...
        public void ServerRealife(int roleID, int x, int y, int direction, Int64 lifeV, int magicV, int staminaV)       // int default HP
        {
            try
            {
                if (!EnableChangMap)
        ...
        /// <param name="mp"></param>
        /// <param name="stamina"></param>
        public void ServerUpdateRoleData(int roleID, Int64 maxHP, int maxMP, int maxStamina, Int64 hp, int mp, int stamina)     // int default HP
        {
            try
            {
                if (!EnableChangMap)
