...
namespace FSPlay.GameEngine.Sprite
{
    ...
    /// <summary>
    /// Event Handler thông báo thay đổi tọa độ
    /// </summary>
    ...
    public partial class GSprite : IObject
    {
        ...
        public GameObject Role2D
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    this.ComponentCharacter = this._Role2D.GetComponent<FSPlay.KiemVu.Control.Component.Character>();
                    this.ComponentMonster = this._Role2D.GetComponent<FSPlay.KiemVu.Control.Component.Monster>();
                    this.ComponentTeleport = this._Role2D.GetComponent<FSPlay.KiemVu.Control.Component.Teleport>();
                }
                else
                {
        ...
        /// </summary>
        public FSPlay.KiemVu.Control.Component.Character ComponentCharacter { get; private set; }

        /// <summary>
        /// Thành phần này khác NULL nếu là quái hoặc NPC
        /// </summary>
        public FSPlay.KiemVu.Control.Component.Monster ComponentMonster { get; private set; }

        /// <summary>
        /// Thành phần này khác NULL nếu là cổng dịch chuyển
        /// </summary>
        public FSPlay.KiemVu.Control.Component.Teleport ComponentTeleport { get; private set; }
        #endregion
        ...
        /// Thay đổi tọa độ
        /// </summary>
        public event CoordinateEventHandler CoordinateChanged = null;
        ...
        private void ChangeCoordinateProperty()
        {
            ...
            this.CoordinateChanged?.Invoke(this);
        }
        ...
        /// Sinh lực
        /// </summary>
        public Int64 HP       // int default HP
        {
            get
            {
                if (this.RoleData != null)
        ...
        /// Sinh lực thượng hạn
        /// </summary>
        public Int64 HPMax		// int default HP
        {
            get
            {
                if (this.RoleData != null)
        ...
        /// </summary>
        private Dictionary<KE_STATE, SpriteSeriesState> seriesStates = new Dictionary<KE_STATE, SpriteSeriesState>();
        ...
        public void Destroy()
        {
            ...
            if (null != this.Role2D)
            {
                ...
                else if (GSpriteTypes.NPC == this.SpriteType || GSpriteTypes.Monster == this.SpriteType || GSpriteTypes.GrowPoint == this.SpriteType || GSpriteTypes.DynamicArea == this.SpriteType)
                {
        ...
        public void OnFrameRender()
        {
            ...
            if (this.SpriteType == GSpriteTypes.Other || this.SpriteType == GSpriteTypes.Leader || this.SpriteType == GSpriteTypes.Monster)
            {
                /// Nếu máu dưới 0
                if (this.HP <= 0)
                {
                    ...
                    if (Global.Data.RoleData.RoleID == this.RoleID)
                    {
                        ...
                        if (PlayZone.GlobalPlayZone.UIReviveFrame == null)
                        {
                            if (Loader.Maps.TryGetValue(Global.Data.RoleData.MapCode, out Map gameMap))
                            {
                                ...
                                PlayZone.GlobalPlayZone.ShowReviveFrame(message, false);
                            }
                        }
                    }
                    return;
                ...
                else
                {
                    ...
                    if (Global.Data.RoleData.RoleID == this.RoleID)
                    {
                        ...
                        if (PlayZone.GlobalPlayZone.UIReviveFrame != null)
                        {
                            ...
                            PlayZone.GlobalPlayZone.CloseReviveFrame();
                        }
                    }
                }
            }
        ...
        private bool ProcessDead()
        {
            ...
            if (this.IsDeath)
            {
                ...
                if (GSpriteTypes.Leader != this.SpriteType && GSpriteTypes.Other != this.SpriteType && GSpriteTypes.FakeRole != this.SpriteType)
                {
                    maxTicks = 3000;
