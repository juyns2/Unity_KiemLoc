...
namespace FSPlay.GameEngine.Network
{
    ...
    public enum TCPGameServerCmds
    {
        ...
        */
        ...
        /// <summary>
        /// Bảng Điểm Thi Đấu loạn Phái
        /// </summary>
        CMD_KT_TYPEOFMATCH_PVP_RANKING_INFO = 50094,
        #endregion
        ...
        /// Oẳn tù tì
        /// </summary>
        CMD_SPR_GOODSOTT = 50400,
        CMD_SPR_OTTDATA = 50401,
        #endregion

        #region Bảo Thạch
        CMD_KT_CLIENT_DRILL_HOLE_ITEM = 50305,
        CMD_KT_CLIENT_ATTACH_GEM = 50306,
        CMD_KT_CLIENT_REMOVE_GEM = 50307,
        CMD_KT_CLIENT_MERGE_GEM = 50308,
        CMD_KT_CLIENT_MERGE_GEM_ALL = 50309,
        #endregion
    ...
    public class TCPCmdHandler
    {
        ...
        public static bool ProcessServerCmd(TCPClient client, int nID, byte[] data, int count)
        {
            ...
            switch (nID)
            {
                ...
                case (int)(TCPGameServerCmds.CMD_SPR_GOODSOTT):
                ...
                case (int)(TCPGameServerCmds.CMD_SPR_OTTDATA):
                ...
                case (int)TCPGameServerCmds.CMD_KT_C2G_USESKILL:
                    {
                        ret = ProcessGameStreamCmd(client, nID, data, count);
                        UnityEngine.Debug.Log("<==================================== TCPCmdHandler ===================================>");
                        break;
                    }
                ...
                #region Thi đấu loạn phái
                case (int)TCPGameServerCmds.CMD_KT_TYPEOFMATCH_PVP_RANKING_INFO:
                    {
                        ret = ProcessGameStreamCmd(client, nID, data, count);
                        break;
                    }
                ...
                #region Bảo Thạch
                case (int)TCPGameServerCmds.CMD_KT_CLIENT_DRILL_HOLE_ITEM:
                    {
                        /// Giải mã gói tin xem là loại gì (String hay Bytes array), trường hợp này là do GS gửi về
                        ret = ProcessGameCmd(client, nID, data, count);
                        break;
                    }
                case (int)TCPGameServerCmds.CMD_KT_CLIENT_ATTACH_GEM:
                    {
                        /// Giải mã gói tin xem là loại gì (String hay Bytes array), trường hợp này là do GS gửi về
                        ret = ProcessGameCmd(client, nID, data, count);
                        break;
                    }
                case (int)TCPGameServerCmds.CMD_KT_CLIENT_REMOVE_GEM:
                    {
                        /// Giải mã gói tin xem là loại gì (String hay Bytes array), trường hợp này là do GS gửi về
                        ret = ProcessGameCmd(client, nID, data, count);
                        break;
                    }
                case (int)TCPGameServerCmds.CMD_KT_CLIENT_MERGE_GEM:
                    {
                        /// Giải mã gói tin xem là loại gì (String hay Bytes array), trường hợp này là do GS gửi về
                        ret = ProcessGameCmd(client, nID, data, count);
                        break;
                    }
                case (int)TCPGameServerCmds.CMD_KT_CLIENT_MERGE_GEM_ALL:
                    {
                        /// Giải mã gói tin xem là loại gì (String hay Bytes array), trường hợp này là do GS gửi về
                        ret = ProcessGameCmd(client, nID, data, count);
                        break;
