...
namespace FSPlay.KiemVu.Entities.Config
{
    ...
    public class ENH
    {
        ...
        public int EnhMAPA1Min { get; set; }			//short default

        /// <summary>
        /// Giá trị MAX của thuộc tính cường hóa 1
        /// </summary>
        [XmlAttribute(AttributeName = "EnhMAPA1Max")]
        public int EnhMAPA1Max { get; set; }			//short default
    ...
    public class RiderProp
    {
        ...
        public int RidePropPA1Min { get; set; }		//short default

        /// <summary>
        /// Giá trị MAX của thuộc tính cường hóa 1
        /// </summary>
        [XmlAttribute(AttributeName = "RidePropPA1Max")]
        public int RidePropPA1Max { get; set; }		//short default
    ...
    public class BasicProp
    {
        ...
        public Int64 BasicPropPA1Min { get; set; }		// BasicPropPA1Max -> int => Int64

        /// <summary>
        /// Giá trị MAX thứ 1 của thuộc tính
        /// </summary>
        [XmlAttribute(AttributeName = "BasicPropPA1Max")]
        public Int64 BasicPropPA1Max { get; set; }		// BasicPropPA1Max -> int => Int64
    ...
    public class ItemData
    {
        ...
        /// <summary>
        /// Kiểm tra chất lượng vũ khí: 7 là hoàng kim
        /// <para>Vũ khí hoàng kim có thể luyện hóa được</para>
        /// </summary>
