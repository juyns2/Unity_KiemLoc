...
namespace FSPlay.KiemVu.Entities.Config
{
    ...
    public class BulletActionSetXML
    {
        ...
        public class BulletResData
        {
            ...
            /// Vị trí nổ X
            /// </summary>
            public int ExplodePosX { get; set; }

            /// <summary>
            /// Vị trí nổ Y
            /// </summary>
            public int ExplodePosY { get; set; }
            ...
            public static BulletResData Parse(XElement xmlNode)
			{
                return new BulletResData()
                {
                    ...
                    ExplodePosX = int.Parse(xmlNode.Attribute("ExplodePosX").Value),
                    ExplodePosY = int.Parse(xmlNode.Attribute("ExplodePosY").Value),
                    ...
                    FlyAnimDuration = int.Parse(xmlNode.Attribute("FlyAnimDuration").Value),
                    FadeOutAnimDuration = int.Parse(xmlNode.Attribute("FadeOutAnimDuration").Value),
                    ExplodeAnimDuration = int.Parse(xmlNode.Attribute("ExplodeAnimDuration").Value),
