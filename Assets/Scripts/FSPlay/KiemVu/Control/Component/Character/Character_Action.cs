...
namespace FSPlay.KiemVu.Control.Component
{
    ...
    public partial class Character
    {
		...
		/// <summary>
        /// Thay đổi chân nguyên
        /// </summary>
        /// <param name="channguyenID"></param>
        public void ChangeChanNguyen(int channguyenID)
        {
            this.Data.ChanNguyenID = channguyenID;
            this.ReloadAnimation();
        }
        ...
        /// </summary>
        /// <param name="ngoaitrangID"></param>
        public void ChangeNgoaiTrang(int ngoaitrangID)
        {
            this.Data.NgoaiTrangID = ngoaitrangID;
            this.ReloadAnimation();
        }
        ...
        /// Thay đổi thần binh
        /// </summary>
        /// <param name="thanbinhID"></param>
        public void ChangeThanBinh(int thanbinhID)
        {
            this.Data.ThanBinhID = thanbinhID;
            this.ReloadAnimation();
        }
        ...
        private void ReloadAnimation()
        {
            ...
            this.reloadAnimationCoroutine = this.StartCoroutine(this.ExecuteSkipFrames(1, () =>
            {
                ...
                else if (UIRoleInfo.hideMask == false)
                {
                    this.animation.Reload();
                }
                else
