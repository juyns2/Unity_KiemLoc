...
namespace Server.Data
{
    ...
    ///  Bảng xếp hạng
    [ProtoContract]
    public class ELIMINATION_SCOREBOARD_1
    {
        /// <summary>
        /// Tên người chơi 1
        /// </summary>
        ...
        /// 
        [ProtoMember(3)]
        public ROUNDSTATE_1 _ROUNDSTATE { get; set; }
    ...
    /// <summary>
    /// Xếp hạng thi đấu loạn
    /// </summary>
    [ProtoContract]
    public class FACTION_PVP_RANKING_1
    {
        /// <summary>
        /// Hạng
        /// </summary>
    ...
    /// </summary>
    [ProtoContract]
    public class FACTION_PVP_RANKING_INFO_1
    {
        /// <summary>
        /// Danh sách xếp hạng người chơi
        /// </summary>
        [ProtoMember(1)]
        public List<FACTION_PVP_RANKING_1> PlayerRanks { get; set; }
        ...
        /// </summary>
        [ProtoMember(3)]
        public List<ELIMINATION_SCOREBOARD_1> ELIMINATION_SCORE { get; set; }
