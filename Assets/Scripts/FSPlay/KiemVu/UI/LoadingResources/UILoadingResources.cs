...
namespace FSPlay.KiemVu.UI.LoadingResources
{
    /// <summary>
    ...
    public class UILoadingResources : TTMonoBehaviour
    {
        ...
        {
            UnityEngine.Debug.Log("Down Config 4");     // Check download config
            /// Tải File
        ...
        private IEnumerator StartDownloadFiles()
        {
            ...
            foreach (UpdateFile file in this.ToDownloadFiles.Files)
            {
                ...
                UnityEngine.Debug.Log(downloader.URL);              // Check download config | down here
                ...
                UnityEngine.Debug.Log(downloader.OutputFileDir);     // Check download config | down here
                /// Gửi yêu cầu tải
