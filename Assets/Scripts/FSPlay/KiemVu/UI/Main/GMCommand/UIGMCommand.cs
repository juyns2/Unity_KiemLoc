...
using FSPlay.KiemVu.UI.Main.GMCommand;
...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UIGMCommand : MonoBehaviour
    {
        ...
        private readonly List<KeyValuePair<string, string>> commands = new List<KeyValuePair<string, string>>()
        {
            ...
            new KeyValuePair<string, string>("ReloadLuckyCircle", "Tải lại thiết lập vòng quay may mắn mới nhất."),
            new KeyValuePair<string, string>("ReloadSeashellCircle", "Tải lại thiết lập vòng quay bách bảo rương mới nhất."),
            ...
            new KeyValuePair<string, string>("BandAcc <color=#fff133>roleName</color> <color=#fff133>minutes</color>", "Cấm người chơi có tên nhân vật với thời gian tương ứng."),
            new KeyValuePair<string, string>("BandAccByRoleID <color=#fff133>targetID</color> <color=#fff133>minutes</color>", "Cấm người chơi có ID với thời gian tương ứng."),
            new KeyValuePair<string, string>("UnBandAcc <color=#fff133>roleName</color>", "Bỏ cấm người chơi có tên nhân vật tương ứng."),
            new KeyValuePair<string, string>("BandChat <color=#fff133>roleName</color> <color=#fff133>hours</color>", "Cấm chat người chơi có tên nhân vật với thời gian tương ứng."),
            ...
            new KeyValuePair<string, string>("ResetXoYo <color=#fff133>targetID</color>", "Reset lại số lượt đi Tiêu Dao Cốc trong ngày cho người chơi có ID tương ứng hoặc bản thân (nếu <color=#fff133>targetID</color> rỗng)."),
            new KeyValuePair<string, string>("AddXoYoMonthStoragePoint <color=#fff133>targetID</color> <color=#fff133>point</color>", "Thêm số điểm tích lũy Tiêu Dao Cốc trong tháng cho người chơi có ID tương ứng hoặc bản thân (nếu <color=#fff133>targetID</color> rỗng)."),
            new KeyValuePair<string, string>("GetXoYoMonthStoragePoint <color=#fff133>targetID</color>", "Hiển thị thông tin tích lũy Tiêu Dao Cốc tháng trước và tháng này của người chơi có ID tương ứng hoặc bản thân (nếu <color=#fff133>targetID</color> rỗng)."),

            new KeyValuePair<string, string>("ResetMiJing <color=#fff133>targetID</color>", "Reset lại số lượt đi Bí Cảnh trong ngày cho người chơi có ID tương ứng hoặc bản thân (nếu <color=#fff133>targetID</color> rỗng)."),
            ...
            new KeyValuePair<string, string>("StartFactionBattle", "Bắt đầu sự kiện thi đấu môn phái."),
            new KeyValuePair<string, string>("EndFactionBattle", "Kết thúc sự kiện thi đấu môn phái."),
            new KeyValuePair<string, string>("StartMatchOf", "Bắt đầu sự kiện loạn chiến môn phái."),
            new KeyValuePair<string, string>("EndMatchOf", "Kết thúc sự kiện loạn chiến môn phái."),
