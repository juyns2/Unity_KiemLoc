...
{
    /// <summary>
    /// Bảng xếp hạng thi đấu loạn phái
    /// </summary>
    public class UITypeOfMatch_Ranking : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Button đóng khung
        ...
        /// </summary>
        [SerializeField]
        private UITypeOfMatch_Ranking_PlayerInfo UI_PlayerInfoPrefab;
        ...
        /// </summary>
        public List<FACTION_PVP_RANKING_1> Data { get; set; }
        #endregion
        ...
        private void AddPlayer(FACTION_PVP_RANKING_1 playerInfo)
        {
            UITypeOfMatch_Ranking_PlayerInfo uiPlayerInfo = GameObject.Instantiate<UITypeOfMatch_Ranking_PlayerInfo>(this.UI_PlayerInfoPrefab);
        ...
        private void RefreshData()
        {
            ...
            /// Dữ liệu bản thân
            FACTION_PVP_RANKING_1 myselfRanking = this.Data[this.Data.Count - 1];
            /// Cập nhật thứ hạng
            ...
            {
                FACTION_PVP_RANKING_1 playerInfo = this.Data[i];
