...
namespace FSPlay.KiemVu.UI.Main.SpecialEvents.FactionBattle
{
    /// <summary>
    /// Bảng thi đấu loạn phái
    /// </summary>
    public class UITypeOfMatch_Round : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Button đóng khung 
        ...
        /// </summary>
        [SerializeField]
        private UITypeOfMatch_Round_RoundInfo[] UI_Round1;

        /// <summary>
        ///  khung khu vực thi đấu 2
        /// </summary>
        [SerializeField]
        private UITypeOfMatch_Round_RoundInfo[] UI_Round2;

        /// <summary>
        ///  khung khu vực thi đấu 3
        /// </summary>
        [SerializeField]
        private UITypeOfMatch_Round_RoundInfo[] UI_Round3;

        /// <summary>
        ///  khung khu vực thi đấu 4
        /// </summary>
        [SerializeField]
        private UITypeOfMatch_Round_RoundInfo[] UI_Round4;
        #endregion
        ...
        /// danh sách thi đấu
        /// </summary>
        private FACTION_PVP_RANKING_INFO_1 _Data;
        /// <summary>
        /// Thông tin bảng xếp hạng môn phái
        /// </summary>
        public FACTION_PVP_RANKING_INFO_1 Data
        {
            get
            {
                return this._Data;
        ...
        {
            foreach (UITypeOfMatch_Round_RoundInfo uiRoundInfo in this.UI_Round1)
            {
                uiRoundInfo.Data = null;
            }
            foreach (UITypeOfMatch_Round_RoundInfo uiRoundInfo in this.UI_Round2)
            {
                uiRoundInfo.Data = null;
            }
            foreach (UITypeOfMatch_Round_RoundInfo uiRoundInfo in this.UI_Round3)
            {
                uiRoundInfo.Data = null;
            }
            foreach (UITypeOfMatch_Round_RoundInfo uiRoundInfo in this.UI_Round4)
            {
                uiRoundInfo.Data = null;
            }
        }
        ...
        private void SetRoundData(UITypeOfMatch_Round_RoundInfo uiRoundInfo, ELIMINATION_SCOREBOARD_1 roundData)
        {
        ...
        private void Refresh()
        {
            ...
            /// Duyệt danh sách
            foreach (ELIMINATION_SCOREBOARD_1 roundData in this.Data.ELIMINATION_SCORE)
            {
                /// Thứ tự vòng
                ...
                /// UI tương ứng
                UITypeOfMatch_Round_RoundInfo uiRoundData = null;
                /// Nếu là vòng 1
                if (roundIndex == 1)
                {
