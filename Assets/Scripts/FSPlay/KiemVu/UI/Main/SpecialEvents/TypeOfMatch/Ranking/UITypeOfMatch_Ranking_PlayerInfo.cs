...
{
    /// <summary>
    /// Thông tin ngươi chơi thi đấu loạn phái
    /// </summary>
    public class UITypeOfMatch_Ranking_PlayerInfo : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Text Hạng
        ...
        #region Properties
        private FACTION_PVP_RANKING_1 _Data;
        /// <summary>
        /// Dữ liệu bảng xếp hạng Tống Kim
        /// </summary>
        public FACTION_PVP_RANKING_1 Data
        {
            get
            {
                return this._Data;
