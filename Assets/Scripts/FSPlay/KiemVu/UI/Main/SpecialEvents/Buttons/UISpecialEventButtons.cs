...
namespace FSPlay.KiemVu.UI.Main.SpecialEvents
{
    ...
    public class UISpecialEventButtons : MonoBehaviour
    {
        ...
        /// <summary>
        /// Button bảng xếp hạng loạn phái
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Button UIButton_TypeOfMatch_OpenBoard;
        ...
        /// <summary>
        /// Mở Bảng Xếp Hạng Thi đấu loạn phái
        /// </summary>
        public Action OpenTypeOfMatchBoard { get; set; }
        ...
        private void InitPrefabs()
        {
            ...
            this.UIButton_TypeOfMatch_OpenBoard.onClick.AddListener(() =>
            {
                this.OpenTypeOfMatchBoard?.Invoke();
            });
        }
        #endregion
        ...
        public void SetButtonState(int id, bool state)
        {
            switch (id)
            {
                ...
                case 55:
                    {
                        this.UIButton_TypeOfMatch_OpenBoard.gameObject.SetActive(state);
                        break;
                    }
            }
        }
        ...
        public void HideAllButtons()
        {
            ...
            this.UIButton_TypeOfMatch_OpenBoard.gameObject.SetActive(false);
