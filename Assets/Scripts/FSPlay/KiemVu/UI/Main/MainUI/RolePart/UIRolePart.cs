using FSPlay.KiemVu.UI.Main.MainUI.RolePart;
...
namespace FSPlay.KiemVu.UI.Main.MainUI
{
    ...
    public class UIRolePart : MonoBehaviour
    {
        ...
        private void UpdateHP()
        {
            ...
            float percent = (float)(this._HP / (double) this._HPMax);	// float default HP not(float)
        ...
        private void UpdateExp()
        {
			...
			this.UIText_ExpValue.text = string.Format("{0}/{1}", this._Exp, this._ExpMax);
        }
        ...
        private void UpdatePKMode()
        {
            ...
            this.UIButton_PKStatus.NormalSpriteName = sprite.SpriteName;
            this.UIButton_PKStatus.DisabledSpriteName = sprite.SpriteName;
            this.UIButton_PKStatus.Color = sprite.Color;
