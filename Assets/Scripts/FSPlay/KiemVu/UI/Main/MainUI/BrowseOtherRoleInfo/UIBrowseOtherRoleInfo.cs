...
namespace FSPlay.KiemVu.UI.Main.MainUI
{
    ...
    public class UIBrowseOtherRoleInfo : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Button UIButton_OTT;
        ...
        private void InitPrefabs()
        {
            ...
            this.UIButton_OTT.onClick.AddListener(this.ButtonOTT_Clicked);
        ...
        /// <summary>
        /// Sự kiện khi Button OTT được ấn
        /// </summary>
        private void ButtonOTT_Clicked()
        {
            this.OTT?.Invoke();
            this.Close?.Invoke();
        }
