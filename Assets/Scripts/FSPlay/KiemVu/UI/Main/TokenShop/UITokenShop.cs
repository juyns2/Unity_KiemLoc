...
using Server.Data;
using FSPlay.KiemVu.UI.Main.TokenShop;
using static FSPlay.KiemVu.Entities.Enum;
using FSPlay.KiemVu.Entities.Config;
using FSPlay.KiemVu.UI.Main.TokenShop.StoreProduct;
#if !UNITY_IOS
...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UITokenShop : MonoBehaviour
    {
        ...
        /// <returns></returns>
        private IEnumerator InitializeIAPManager(Action done)
        {
#if !UNITY_IOS
            /// Nếu đã được tạo thì thôi
            ...
            /// Hiện bảng chờ
            KTGlobal.ShowLoadingFrame("Đang tải dữ liệu...");

            /// Danh sách gói hàng
            List<string> productIDs = new List<string>();
            /// Duyệt danh sách gói hàng từ Server đổ về
            foreach (TokenShopStoreProduct productData in this.Data.StoreProducts)
            {
                productIDs.Add(productData.ID);
            }
            /// Tạo mới đối tượng
            IAPManager.Instance.Init(productIDs);
            /// Đợi đến khi tạo xong
        ...
        private void InitStoreProductBuy()
        {
            ...
            ///    }
            //};
			///Android ẩn khung mua KNB ingame tại kỳ trận các
			this.UIToggle_OpenBuyStoreProductFrame.gameObject.SetActive(false);
#else
            ///IOS ẩn khung mua KNB ingame tại kỳ trận các
			this.UIToggle_OpenBuyStoreProductFrame.gameObject.SetActive(false);
#endif
        }
        ...
        /// <summary>
        /// Sự kiện khi Toggle mở tiệm Đồng được ấn
        /// </summary>
        /// <param name="isSelected"></param>
        ...
        /// <summary>
        /// Sự kiện khi Toggle mở tiệm Đồng khóa được ấn
        /// </summary>
        /// <param name="isSelected"></param>
