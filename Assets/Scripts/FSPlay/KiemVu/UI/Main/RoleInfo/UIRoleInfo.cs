...
namespace FSPlay.KiemVu.UI.Main.RoleInfo
{
    ...
    {
        public static bool hideMask = true;
        #region Define

        #region DEVTAN 250115
        [SerializeField]
        ...
        public Action<GoodsData> AdvertiseItem { get; set; }
        public Action<GoodsData, int> Split { get; set; }
        public Action<GoodsData> MergeGem { get; set; }
        public Action<GoodsData> MergeGemAll { get; set; }*/
        #endregion DEVTAN 250115
        ...
        /// </summary>
        [SerializeField]
        private TextMeshProUGUI UIText_FamousPoint;
		...
		/// <summary>
        /// Ô trang bị Chân Nguyên
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_ChanNguyen;
		
		/// <summary>
        /// Ô trang bị Ngoại Trang
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_NgoaiTrang;
		
		/// <summary>
        /// Ô trang bị Thần Binh
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_ThanBinh;
        ...
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_Trap;
        ...
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_HeroicSeal;

        /// <summary>
        /// Ô trang bị Bí tịch
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_Book;
        ...
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_Aromantic;
        ...
        /// </summary>
        [SerializeField]
        private UIItemBox UIItemBox_Necklace;
        ...
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Toggle UIToggle_HideMask;
        ...
        private void ToggleHideMask_Selected(bool isOn)
        {
            hideMask = isOn;
        }
        ...
        private void InitPrefabs()
        {
            ...
            this.UIToggle_HideMask.isOn = UIRoleInfo.hideMask;
            this.UIToggle_HideMask.onValueChanged.AddListener(ToggleHideMask_Selected);
        ...
        private void RefreshPropertiesTabData()
        {
            ...
            {
                if (PlayZone.GlobalPlayZone.UIRoleRemainPoint == null)
                {
                    PlayZone.GlobalPlayZone.ShowUIRoleRemainPoint();
                }

                PlayZone.GlobalPlayZone.UIRoleRemainPoint.Str = this._RoleAttributes.Str;
                PlayZone.GlobalPlayZone.UIRoleRemainPoint.Dex = this._RoleAttributes.Dex;
                PlayZone.GlobalPlayZone.UIRoleRemainPoint.Sta = this._RoleAttributes.Sta;
                PlayZone.GlobalPlayZone.UIRoleRemainPoint.Int = this._RoleAttributes.Int;
                PlayZone.GlobalPlayZone.UIRoleRemainPoint.RemainPoint = this._RoleAttributes.RemainPoint;
                PlayZone.GlobalPlayZone.UIRoleRemainPoint.Accept = (nStr, nDex, nSta, nInt) =>
                {
        ...
        private void RefreshEquips()
        {
            ...
            this.UIItemBox_Necklace.Data = null;
            this.UIItemBox_Ring.Data = null;
            this.UIItemBox_Aromantic.Data = null;
            ...
            this.UIItemBox_Trap.Data = null;
            this.UIItemBox_FiveElementSeal.Data = null;
            this.UIItemBox_HeroicSeal.Data = null;
            this.UIItemBox_Book.Data = null;
            this.UIItemBox_Mask.Data = null;
			this.UIItemBox_ChanNguyen.Data = null;
            this.UIItemBox_NgoaiTrang.Data = null;
            this.UIItemBox_ThanBinh.Data = null;
            ...
            this.UIItemBox_Necklace.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Necklace);
            };
            this.UIItemBox_Ring.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Ring);
            };
            this.UIItemBox_Aromantic.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Aromantic);
            };
            ...
            this.UIItemBox_Trap.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Trap);
            };
            this.UIItemBox_FiveElementSeal.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_FiveElementSeal);
            };
            this.UIItemBox_HeroicSeal.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_HeroicSeal);
            };
            this.UIItemBox_Book.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Book);
            };
            this.UIItemBox_Mask.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_Mask);
            };
			this.UIItemBox_ChanNguyen.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_ChanNguyen);
            };
			this.UIItemBox_NgoaiTrang.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_NgoaiTrang);
            };
			this.UIItemBox_ThanBinh.Click = () =>
            {
                this.ItemBox_Clicked(this.UIItemBox_ThanBinh);
            };
                ...
                foreach (GoodsData equip in Global.Data.RoleData.GoodsDataList)
                {
                    ...
                    if (Global.Data.ShowReserveEquip)
                    {
                        ...
                        switch (usingIndex)
                        {
                            ...
                            /// Liên
                            case (int)Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_NECKLACE:
                                {
                                    this.UIItemBox_Necklace.Data = equip;
                                    break;
                                }
                            /// Nhẫn
                            ...
                            case (int)Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_PENDANT:
                                {
                                    this.UIItemBox_Aromantic.Data = equip;
                                    break;
                                }
                            /// Phù
                            ...
                            /// Trận
                            case (int)Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_ZHEN:
                                {
                                    this.UIItemBox_Trap.Data = equip;
                                    break;
                                }
                            /// Ngũ hành ấn
                            ...
                            /// Quan ấn
                            case (int)Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_CHOP:
                                {
                                    this.UIItemBox_HeroicSeal.Data = equip;
                                    break;
                                }
                            /// Mật tịch
                            case (int)Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_BOOK:
                                {
                                    this.UIItemBox_Book.Data = equip;
                                    break;
                                }
                            /// Mặt nạ
							...
							/// Chân Nguyên
							case (int) Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_CHANNGUYEN:
								{
									this.UIItemBox_ChanNguyen.Data = equip;
									break;
								}
							/// Ngoại Trang
							case (int) Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_NGOAITRANG:
								{
									this.UIItemBox_NgoaiTrang.Data = equip;
									break;
								}
							/// Thần Binh
							case (int) Entities.Enum.KE_EQUIP_POSITION.emEQUIPPOS_THANBINH:
								{
									this.UIItemBox_ThanBinh.Data = equip;
									break;
								}
                        }
                    }
        ...
        private void BagItem_Clicked(GoodsData itemGD)
        {
            ...
            if (itemData.IsEquip)
            {
                buttons.Add(new KeyValuePair<string, Action>("Trang bị", () => {
                    ...
                    int pos = Loader.Loader.g_anEquipPos[itemData.DetailType];
            ...
            //Ghép bảo thạch
            else if (itemData.Genre == 24)
            {
                buttons.Add(new KeyValuePair<string, Action>("Ghép", () => {
                    Require drillingRequire = Loader.Loader.gemStone.MergeGem[0];
                    if (drillingRequire != null)
                    {
                        string notifyString = "Ghép Bảo Thạch này cần 3 bảo thạch cùng loại";
                        if (drillingRequire.Money > 0)
                        {
                            notifyString += " và:\n" + KTGlobal.GetDisplayMoney(drillingRequire.Money) + " Bạc";
                        }
                        if (drillingRequire.BoundMoney > 0)
                        {
                            notifyString += " và:\n" + KTGlobal.GetDisplayMoney(drillingRequire.BoundMoney) + " Bạc khóa";
                        }
                        if (drillingRequire.Gold > 0)
                        {
                            notifyString += " và:\n" + KTGlobal.GetDisplayMoney(drillingRequire.Gold) + " Đồng";
                        }
                        if (drillingRequire.BoundGold > 0)
                        {
                            notifyString += " và:\n" + KTGlobal.GetDisplayMoney(drillingRequire.BoundGold) + " Đồng khóa";
                        }
                        if (drillingRequire.THL > 0)
                        {
                            notifyString += " và:\n" + drillingRequire.THL + " Tinh Hoạt Lực";
                        }
                        ...
                        notifyString += "\nBạn có xác nhận muốn ghép không?";
                        KTGlobal.ShowMessageBox("Ghép bảo thạch", notifyString, () =>
                        {
                            //this.MergeGem?.Invoke(itemGD);
                            // DEVTAN 250115
                            GameInstance.Game.SendMergeGem(itemGD.GoodsID, 1);
                            KTGlobal.CloseItemInfo();
                        }, true);
                    }
                }));

                buttons.Add(new KeyValuePair<string, Action>("Ghép tất cả", () => {
                    Require drillingRequire = Loader.Loader.gemStone.MergeGem[0];
                    if (drillingRequire != null)
                    {
                        string notifyString = "Ghép Bảo Thạch này cần 3 bảo thạch cùng loại";
                        ...
                        KTGlobal.ShowMessageBox("Ghép bảo thạch", notifyString, () =>
                        {
                            //this.MergeGemAll?.Invoke(itemGD);
                            // DEVTAN 250115
                            GameInstance.Game.SendMergeGem(itemGD.GoodsID, 2);
                            KTGlobal.CloseItemInfo();
                        }, true);
                    }
                }));
        ...
        public void UpdateRoleData()
        {
            ...
            this.UIText_FamousPoint.text = Global.Data.RoleData.Prestige.ToString();
