...
namespace FSPlay.KiemVu.UI.Main.RoleInfo
{
    ...
    public class UIRoleInfo_PropertiesTab : MonoBehaviour
    {
        #region Define
        /// <summary>
        /// Button sửa toàn bộ trang bị
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Button UIButton_FixAllEquips;
        ...
        private Int64 _HP;		// int default HP
        /// <summary>
        /// Sinh lực
        /// </summary>
        ...
        private Int64 _HPMax;	// int default HP
        /// <summary>
        /// Sinh lực tối đa
        /// </summary>
        ...
        private Int64 _Damage;		// Int Default DAMAGE -> Int64
        /// <summary>
        /// Lực Tay
        /// </summary>
        public Int64 Damage			// Int Default DAMAGE -> Int64
        {
            get
            {
                return this._Damage;
        ...
        public int CritAtk
        {
            ...
            {
                this._CritAtk = value;
                this.UIText_CritAtk.text = value.ToString();
            }
        }
        ...
        /// <summary>
        /// Sự kiện khi Button Sửa toàn bộ trang bị được ấn
        /// </summary>
        public Action FixAllEquip { get; set; }
        ...
        {
            this.UIButton_FixAllEquips.onClick.AddListener(this.ButtonFixAllEquips_Clicked);
        ...
        /// Sự kiện khi Button Sửa toàn bộ trang bị được ấn
        /// </summary>
        private void ButtonFixAllEquips_Clicked()
        {
            this.FixAllEquip?.Invoke();
        }
        ...
        private void RefreshHP()
        {
            if (this._HPMax > 0)
            {
                ...
                this.UISlider_HPBar.value = (float)(this._HP / (double) this._HPMax);	// float default HP
            }
        }
