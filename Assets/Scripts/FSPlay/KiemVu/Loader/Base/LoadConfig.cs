...
namespace FSPlay.KiemVu.Loader
{
    ...
    public class LoadConfig : TTMonoBehaviour
    {
        ...
        private IEnumerator InitGameRes()
        {
            ...
            yield return wait;
            Loader.LoadGem(ResourceLoader.LoadXMLFromBundle(this.GameConfigAssetBundle, Consts.GemStone));
        ...
        public static IEnumerator LoadSkillData()
        {
            yield return null;
            Loader.LoadSkillData(ResourceLoader.LoadXMLFromBundle(null, Consts.XML_SKILLDATA_FILE));
        }
