    ...
    public static partial class Loader
    {
        ...
        private static void LoadItemFromPath(AssetBundle bundle, string pathName)
        {
            ...
            foreach (XElement node in xmlNode.Elements())
            {
                ...
                itemData.QualityPrefix = node.Attribute("QualityPrefix") == null ? -1 : int.Parse(node.Attribute("QualityPrefix").Value);
                ...
                if (node.Element("ListBasicProp") != null)
                {
                    ...
                    foreach (XElement subNode in node.Elements("ListBasicProp"))
                    {
                        BasicProp basicProp = new BasicProp()
                        {
                            ...
                            BasicPropPA1Min = subNode.Attribute("BasicPropPA1Min") == null ?  0 : Int64.Parse(subNode.Attribute("BasicPropPA1Min").Value),	// BasicPropPA1Max -> int => Int64
                            BasicPropPA1Max = subNode.Attribute("BasicPropPA1Max") == null ?  0 : Int64.Parse(subNode.Attribute("BasicPropPA1Max").Value),	// BasicPropPA1Max -> int => Int64
                            BasicPropPA2Min = subNode.Attribute("BasicPropPA2Min") == null ?  0 : int.Parse(subNode.Attribute("BasicPropPA2Min").Value),
                            BasicPropPA2Max = subNode.Attribute("BasicPropPA2Max") == null ?  0 : int.Parse(subNode.Attribute("BasicPropPA2Max").Value),
                            BasicPropPA3Min = subNode.Attribute("BasicPropPA3Min") == null ?  0 : int.Parse(subNode.Attribute("BasicPropPA3Min").Value),
                            BasicPropPA3Max = subNode.Attribute("BasicPropPA3Max") == null ?  0 : int.Parse(subNode.Attribute("BasicPropPA3Max").Value),
                ...
                if (node.Element("ListEnhance") != null)
                {
                    ...
                    foreach (XElement subNode in node.Elements("ListEnhance"))
                    {
                        ENH enh = new ENH()
                        {
                            ...
                            EnhMAPA1Min = subNode.Attribute("EnhMAPA1Min") == null ? (int) 0 : int.Parse(subNode.Attribute("EnhMAPA1Min").Value), /* short default */
                            EnhMAPA1Max = subNode.Attribute("EnhMAPA1Max") == null ? (int) 0 : int.Parse(subNode.Attribute("EnhMAPA1Max").Value), /* short default */
                ...
                if (node.Element("RiderProp") != null)
                {
                    ...
                    foreach (XElement subNode in node.Elements("RiderProp"))
                    {
                        RiderProp riderProp = new RiderProp()
                        {
                            ...
                            RidePropPA1Min = subNode.Attribute("RidePropPA1Min") == null ? (int) 0 : int.Parse(subNode.Attribute("RidePropPA1Min").Value), /* short default */
                            RidePropPA1Max = subNode.Attribute("RidePropPA1Max") == null ? (int) 0 : int.Parse(subNode.Attribute("RidePropPA1Max").Value), /* short default */
        ...
        public static void LoadItems(AssetBundle bundle)
        {
			...
			Loader.LoadItemFromPath(bundle, Consts.BasicItem_channguyen);
			Loader.LoadItemFromPath(bundle, Consts.BasicItem_aont);
