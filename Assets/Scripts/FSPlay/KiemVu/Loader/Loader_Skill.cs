...
namespace FSPlay.KiemVu.Loader
{
    ...
    public static partial class Loader
    {
        ...
        /// Danh sách kỹ năng
        /// </summary>
        public static Dictionary<Int64, SkillDataEx> Skills { get; private set; } = new Dictionary<Int64, SkillDataEx>();   // BasicPropPA1Max -> int => Int64 no(int) 250110
        ...
        /// </summary>
        public static Dictionary<Int64, EnchantSkill> EnchantSkills { get; private set; } = new Dictionary<Int64, EnchantSkill>();  // BasicPropPA1Max -> int => Int64 no(int) 250110

        /// <summary>
        /// Danh sách kỹ năng tự động xuất
        /// </summary>
        public static Dictionary<Int64, AutoSkill> AutoSkills { get; private set; } = new Dictionary<Int64, AutoSkill>();   // BasicPropPA1Max -> int => Int64 no(int) 250110
