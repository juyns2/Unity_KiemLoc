...
namespace FSPlay.KiemVu.Utilities.UnityComponent
{
	...
	public class MonsterAnimation2D : TTMonoBehaviour
    {
        ...
        /// </summary>
        /// <returns></returns>
        private IEnumerator DoPlay(MonsterActionType actionType, float duration, bool isRepeat, float repeatAfter, bool isContinueFromCurrentFrame, Action Callback)
        {
            #region Init
            /// Danh sách Sprite
            ...
            /// Tên động tác
            string actionName = MonsterAnimationManager.Instance.GetActionName(actionType);
        ...
        /// <returns></returns>
        public IEnumerator DoActionAsync(MonsterActionType actionType, Direction dir, float duration, bool isRepeat = false, float repeatAfter = 0, bool isContinueFromCurrentFrame = false, Action Callback = null)
        {
            ...
            this.Stop();
            this.playerCoroutine = this.StartCoroutine(this.DoPlay(actionType, duration, isRepeat, repeatAfter, isContinueFromCurrentFrame, Callback));
        }
