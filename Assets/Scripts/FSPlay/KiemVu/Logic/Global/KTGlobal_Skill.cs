...
using System.Text;
using UnityEngine;
using static FSPlay.KiemVu.Entities.Config.EnchantSkill;
...
namespace FSPlay.KiemVu
{
    ...
    public static partial class KTGlobal
    {
        ...
        /// </summary>
        public static readonly int NewbieHandAttackSkill = 1;
        ...
        public static SkillDataEx GetNewbieSkillCorrespondingToCurrentWeapon()
        {
            ...
            foreach (int skillID in KTGlobal.ListNewbieAttackSkill)
            {
                ...
                if (Loader.Loader.Skills.TryGetValue(skillID, out SkillDataEx skillData))
                {
                    ...
                    if (skillData.WeaponLimit != 0 && skillData.WeaponLimit == weaponData.Category)
                    {
                        return skillData;
                    }
                }
        ...
        public static bool IsCanUseSkill(SkillDataEx skillData)
        {
            ...
            if (KTGlobal.ListNewbieAttackSkill.Contains(skillData.ID))
            {
                ...
                if (skillData.WeaponLimit != (int) KE_EQUIP_WEAPON_CATEGORY.emKEQUIP_WEAPON_CATEGORY_ALL)
                {
                    ...
                    if (skillData.WeaponLimit == (int) KE_EQUIP_WEAPON_CATEGORY.emKEQUIP_WEAPON_CATEGORY_HAND)
                    {
                        /// Nếu có vũ khí
                        if (weapon != null)
                        {
                            if (Loader.Loader.Items.TryGetValue(weapon.GoodsID, out ItemData itemData))
                            {
                                ...
                                if (itemData.Category != skillData.WeaponLimit)
                                {
                                    return false;
                                }
                            }
            ...
            foreach (Server.Data.SkillData skillData in Global.Data.RoleData.SkillDataList)
            {
                if (skillData.Level > 0 && Loader.Loader.Skills.TryGetValue(skillData.SkillID, out SkillDataEx _skill))
                {
                    ...
                    if (skillPd.ContainsKey((int) MAGIC_ATTRIB.magic_addenchant))
                    {
                        ...
                        Int64 enchantID = attrib.nValue[0]; // BasicPropPA1Max -> int => Int64 no(int) 250110
                        int enchantSkillLevel = (int)attrib.nValue[1]; // BasicPropPA1Max -> int => Int64 no(int) 250110
        ...
        /// <param name="skill"></param>
        /// <returns></returns>
        private static Int64 GetTotalAppendDamageByOtherSkills(SkillDataEx skill)	// Int Default DAMAGE -> Int64
        {
            Int64 totalEnchantDamagePercent = 0;		// Int Default DAMAGE -> Int64
            foreach (Server.Data.SkillData skillData in Global.Data.RoleData.SkillDataList)
            {
                if (skillData.Level > 0 && Loader.Loader.Skills.TryGetValue(skillData.SkillID, out SkillDataEx _skill))
                {
                    ...
                    if (_skillPd.ContainsKey((int) MAGIC_ATTRIB.magic_skilladdition_adddamagepercent))
                    {
                        ...
                        Int64 enchantID = attrib.nValue[0]; // BasicPropPA1Max -> int => Int64 no(int) 250110
                        Int64 enchantDamagePercent = attrib.nValue[1];  // BasicPropPA1Max -> int => Int64 no(int) 250110
                    ...
                    if (_skillPd.ContainsKey((int) MAGIC_ATTRIB.magic_skilladdition_adddamagepercent6))
                    {
                        ...
                        Int64 enchantID = attrib.nValue[0]; // BasicPropPA1Max -> int => Int64 no(int) 250110
                        Int64 enchantDamagePercent = attrib.nValue[1];  // BasicPropPA1Max -> int => Int64 no(int) 250110s
                        if (enchantID == skill.ID)
                        {
                            totalEnchantDamagePercent += enchantDamagePercent;
                        }
        ...
        /// </summary>
        private static string AnalysisPropertyInfo(SkillDataEx skill, PropertyDictionary pd, Int64 level, bool isChildSkill = false, bool isSupportSkill = false)// BasicPropPA1Max -> int => Int64 no(int) 250110
        {
            StringBuilder builder = new StringBuilder();
            ...
            if (!isChildSkill && propertyDictionary.ContainsKey((int) MAGIC_ATTRIB.magic_skill_cost_v))
            {
                ...
                if (attrib != null)
                {
                    builder.AppendLine(string.Format(PropertyDefine.PropertiesByID[(int) MAGIC_ATTRIB.magic_skill_cost_v].Description, attrib.nValue[0]));
                }
            }
            if (!isChildSkill)
            {
            ...
            Dictionary<Int64, List<string>> skillAdditions = new Dictionary<Int64, List<string>>();// BasicPropPA1Max -> int => Int64 no(int) 250110
            ...
            foreach (KeyValuePair<short, object> record in propertyDictionary)
            {
                ...
                switch (record.Key)
                {
                    ...
                    case (int) MAGIC_ATTRIB.magic_skill_startevent:
                        Loader.Loader.Skills.TryGetValue(attrib.nValue[0], out startSkill);
                        break;
                    ...
                    case (int) MAGIC_ATTRIB.magic_addenchant:
                        Int64 enchantID = attrib.nValue[0]; // BasicPropPA1Max -> int => Int64 no(int) 250110
                        enchantSkillLevel = (int)attrib.nValue[1];  // BasicPropPA1Max -> int => Int64 no(int) 250110
                        Loader.Loader.EnchantSkills.TryGetValue(enchantID, out enchantSkill);
                        break;

                    case (int) MAGIC_ATTRIB.magic_autoskill:
                        autoSkillID = (int)attrib.nValue[0];    // BasicPropPA1Max -> int => Int64 no(int) 250110
                        autoSkillLevel = (int)attrib.nValue[1]; // BasicPropPA1Max -> int => Int64 no(int) 250110
                        break;
                    ...
                    case (int) MAGIC_ATTRIB.magic_skill_param1_v:
                        if (skill.RawPropertiesConfig == "miyingzong")
                        {
            ...
            Int64 totalEnchantDamagePercent = KTGlobal.GetTotalAppendDamageByOtherSkills(skill);    // Int Default DAMAGE -> Int64
            ...
            /// Hỗ trợ
            foreach (KeyValuePair<Int64, List<string>> pair in skillAdditions)  // BasicPropPA1Max -> int => Int64 no(int) 250110
            {
                Int64 enchantSkillID = pair.Key;    // BasicPropPA1Max -> int => Int64 no(int) 250110
            ...
            if (!isChildSkill && vanishSkill != null)
            {
                if (Loader.Loader.Skills.TryGetValue(vanishSkill.ID, out SkillDataEx vanishSkillData))
                {
                    ...
                    {
                        builder.AppendLine();
                        builder.AppendLine(string.Format("<color=#ffadfa>Kết thúc thi triển:</color> <color=#0dff00>[{0} (Cấp {1})]</color>", vanishSkillData.Name, level));
            ...
            if (!isChildSkill && collidSkill != null)
            {
                if (Loader.Loader.Skills.TryGetValue(collidSkill.ID, out SkillDataEx collidSkillData))
                {
                    ...
                    {
                        builder.AppendLine();
                        builder.AppendLine(string.Format("<color=#ffadfa>Đánh trúng thi triển:</color> <color=#0dff00>[{0} (Cấp {1})]</color>", collidSkillData.Name, level));
        ...
        public static void ShowSkillItemInfo(SkillDataEx skill, int baseLevel, int level)
        {
            ...
            PlayZone.GlobalPlayZone.UISuperToolTip.ShowSubToolTip = false;

            UISuperToolTip_Component uiSuperToolTip = PlayZone.GlobalPlayZone.UISuperToolTip.MainToolTip;
            ...
            /// Vũ khí yêu cầu
            if (skill.WeaponLimit != 0)
            {
                string weaponRequireText = KTGlobal.GetWeaponKind(skill.WeaponLimit);
            ...
            /// Tạo Tooltip
            PlayZone.GlobalPlayZone.UISuperToolTip.Build();
        }
