                    ...
                    if (skill.SkillID == 98)
                    {
                        ...
                        if (KTAutoAttackSetting._AutoConfig._AutoPKConfig.IsBuffNM)
                        {
                            if (Global.Data.RoleData.TeamID != -1)
                            {
                                ...
                                {
                                    // % MÁU CỦA ĐỒNG ĐỘI
                                    int HpPercent = (int)(Role.HP * 100 / Role.MaxHP);      // int default HP	add (int)
                            ...
                            else
                            {
                                ...
                                int HpPercent = (int)(Global.Data.RoleData.CurrentHP * 100 / Global.Data.RoleData.MaxHP);       // int default HP	add (int)
