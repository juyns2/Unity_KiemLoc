...
using FSPlay.KiemVu.UI.Main.GiftCode;
using FSPlay.KiemVu.UI.Main.MainUI;
using FSPlay.KiemVu.UI.Main.SpecialEvents;
...
public partial class PlayZone
{
    ...
    protected void InitUISpecialEventButtons()
    {
        ...
        this.UISpecialEventButtons.OpenColonyDisputeBoard = () =>
        {
            KT_TCPHandler.SendGetColonyDisputeInfo();
        };
        this.UISpecialEventButtons.OpenTypeOfMatchBoard = () =>
        {
            KT_TCPHandler.SendGetTypeOfMatchData();
        };
    }
    #endregion
    ...
    #region Thi đấu loạn phái
    #region Bảng xếp hạng
    /// <summary>
    /// Bảng xếp hạng thi đấu môn phái
    /// </summary>
    public UITypeOfMatch_Ranking UITypeOfMatch_Ranking { get; protected set; }

    /// <summary>
    /// Hiển thị khung bảng xếp hạng Thi đấu môn phái
    /// </summary>
    /// <param name="data"></param>
    public void OpenUITypeOfMatchRanking(List<FACTION_PVP_RANKING_1> data)
    {
        CanvasManager canvas = Global.MainCanvas.GetComponent<CanvasManager>();
        this.UITypeOfMatch_Ranking = canvas.LoadUIPrefab<UITypeOfMatch_Ranking>("MainGame/SpecialEvents/UITypeOfMatch_Ranking");
        canvas.AddUI(this.UITypeOfMatch_Ranking);

        this.UITypeOfMatch_Ranking.Close = this.CloseUITypeOfMatchRanking;
        this.UITypeOfMatch_Ranking.Data = data;
    }

    /// <summary>
    /// Đóng khung thông tin nhân vật
    /// </summary>
    public void CloseUITypeOfMatchRanking()
    {
        if (this.UITypeOfMatch_Ranking != null)
        {
            GameObject.Destroy(this.UITypeOfMatch_Ranking.gameObject);
            this.UITypeOfMatch_Ranking = null;
        }
    }
    #endregion
    ...
    /// Khung thông tin các vòng đấu trong thi đấu môn phái
    /// </summary>
    public UITypeOfMatch_Round UITypeOfMatch_Round { get; set; }

    /// <summary>
    /// Hiện khung thông tin các vòng đấu trong thi đấu môn phái
    /// </summary>
    /// <param name="data"></param>
    public void OpenUITypeOfMatchRoundInfo(FACTION_PVP_RANKING_INFO_1 data)
    {
        if (this.UITypeOfMatch_Round != null)
        {
            return;
        }

        CanvasManager canvas = Global.MainCanvas.GetComponent<CanvasManager>();
        this.UITypeOfMatch_Round = canvas.LoadUIPrefab<UITypeOfMatch_Round>("MainGame/SpecialEvents/UITypeOfMatch_Round");
        canvas.AddUI(this.UITypeOfMatch_Round);

        this.UITypeOfMatch_Round.Close = this.CloseUITypeOfMatchRoundInfo;
        this.UITypeOfMatch_Round.Data = data;
    }

    /// <summary>
    /// Đóng khung thông tin các vòng đấu trong thi đấu môn phái
    /// </summary>
    public void CloseUITypeOfMatchRoundInfo()
    {
        if (this.UITypeOfMatch_Round != null)
        {
            GameObject.Destroy(this.UITypeOfMatch_Round.gameObject);
            this.UITypeOfMatch_Round = null;
        }
    }
    #endregion
    #endregion
